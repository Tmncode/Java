...
public class AssignVolunteer5 {
    public static void main(String[] args) {
        ...
        while(donationType < CLOTHING_CODE || donationType > OTHER_CODE){
            System.out.println("You entered " + donationType + " which is not valid donation type.");
            System.out.print("Please enter a value number between " + CLOTHING_CODE + " and " + OTHER_CODE + " ...");
            System.out.print("Enter an integer... ");
            donationType = input.nextInt();
