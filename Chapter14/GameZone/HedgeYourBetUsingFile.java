...
// Modify the HedgeYourBet game so that it stores the player's score from the last game in a file and
// displays the previous score at the start of each new game.
//
// (The first time you play the game, the previous score should be 0.) Save the game as HedgeYourBetUsingFile.java.
