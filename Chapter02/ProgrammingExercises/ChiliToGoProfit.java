...
public class ChiliToGoProfit {
    public static void main(String[] args)
    {
        ...
        System.out.println(childMeals + " child meals were ordered at " + KID_PRICE + " each.");
