...
// Write an application named ElementArray that creates and displays an array that holds at least two elements of each type.
// Save the files as Element.java, MetalElement.java, NonMetalElement.java, and ElementArray.java.
