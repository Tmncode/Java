    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            while(!(idString.equals(QUIT))){
                id = Integer.parseInt(idString); // The employee's ID number will be used to determine the records position
                ...
                fc.position(id * RECSIZE); // The position is the ID number value times the size of each records
                fc.write(buffer);
