...
// An account number is valid only if the last digit is equal to the remainder when the sum of the
// first five digits is divided by 10. For example, the number 223355 is valid because the sum of the
// first five digits is 15, the remainder when 15 is divided by 10 is 5, and the last digit is 5.
